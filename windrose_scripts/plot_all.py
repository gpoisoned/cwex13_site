...
def set_legend(ax):
    l = ax.legend(borderaxespad=0.10, loc=4)
...
if __name__ == '__main__':
	...
	for fileName in allfiles:
		...
		start_val = 57
		if lines[57] == "HeaderLength=55":
			start_val += 57 

		lines = lines[start_val:]
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD40, WS40, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD60, WS60, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD80, WS80, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD100, WS100, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD120, WS120, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD140, WS140, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD160, WS160, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD180, WS180, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD200, WS200, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
	...
	plt.figure()
	ax = new_axes()
	ax.bar(WD220, WS220, normed=True,bins=np.arange(0,20,2), opening=0.8, edgecolor='white')
	set_legend(ax)
